...
public class CollectionCategoria extends AccessManager implements AccessInterface {
       public Vector select(HashMap param) throws Exception{
        Vector vec= new Vector();
        try{
        		String sql="SELECT * from categoria where cod_categoria is not null ";
            ...
            while(rst.next()){
                ...
                categoria.setCodigo(rst.getString("cod_categoria"));
