...
public class CollectionZona extends AccessManager implements AccessInterface {
       public Vector select(HashMap param) throws Exception{
        Vector vec= new Vector();
        try{
        		String sql="SELECT * from zona where cod_zona is not null ";
            ...
            while(rst.next()){
                ...
                Zona value=new Zona();
                value.setCodigo(rst.getString("cod_zona"));
