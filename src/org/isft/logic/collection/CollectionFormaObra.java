...
public class CollectionFormaObra extends AccessManager implements AccessInterface {
       public Vector select(HashMap param) throws Exception{
        Vector vec= new Vector();
        try{
        		String sql="SELECT * from forma_obra where cod_forma_obra is not null ";
            ...
            while(rst.next()){
                ...
                FormaObra value=new FormaObra();
                value.setCodigo(rst.getString("cod_forma_obra"));
