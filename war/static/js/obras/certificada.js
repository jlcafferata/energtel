...
function certificar(poa){
	$('.modal-body').load("jsp/obras/seguimiento.jsp?accion=certificar&poa="+poa+"&modalidad=M");
	$('#myModal').modal('show');
}
...
function facturar(poa){
	$('.modal-body').load("jsp/obras/seguimiento.jsp?accion=facturar&poa="+poa+"&modalidad=M");
	$('#myModal').modal('show');
}
