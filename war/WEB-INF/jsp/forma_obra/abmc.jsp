...
<script type="text/javascript" src="/ENERGTEL/static/js/forma_obra/forma_obra.js"></script>
<title>Documento sin t&iacute;tulo</title>
</head>

<body>
<fieldset style="left:20px">
<legend>Administraci&oacute;n de Forma de obra</legend> 
<div id="div_cabecera">
	<div class="row">
		<div class="span2" style="text-align:right">Codigo forma de obra</div>
		<div class="span2"><input type="text" name="txt_forma_obra" id="txt_forma_obra"  style="width:80px" maxlength="9"/></div>
