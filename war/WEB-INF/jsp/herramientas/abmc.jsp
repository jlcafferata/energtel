...
<script type="text/javascript" src="/ENERGTEL/static/js/herramientas/herramientas.js"></script>
...
<legend>Administraci&oacute;n de Herramientas</legend>
<div id="div_cabecera">
	<div class="row">
		<div class="span2" style="text-align:right">Codigo herramienta</div>
		<div class="span2"><input type="text" name="txt_herramienta" id="txt_herramienta"  style="width:80px" maxlength="9"/></div>
