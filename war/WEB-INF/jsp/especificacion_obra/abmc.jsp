...
<script type="text/javascript" src="/ENERGTEL/static/js/especificacion_obra/especificacion_obra.js"></script>
<title>Documento sin t&iacute;tulo</title>
</head>

<body>
<fieldset style="left:20px">
<legend>Administraci&oacute;n de Especificaci&oacute;n de obra</legend>
<div id="div_cabecera">
	<div class="row">
		<div class="span2" style="text-align:right">Codigo especificaci&oacute;n</div>
		<div class="span2"><input type="text" name="txt_especificacion" id="txt_especificacion"  style="width:80px" maxlength="9"/></div>
